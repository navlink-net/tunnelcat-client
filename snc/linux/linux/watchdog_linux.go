...
// Watchdog coordination uses three files in the daemon data directory:
//
...
// IsDaemonSocketLive returns true if the IPC socket at socketPath is reachable
// (another instance of the daemon is already running and listening).
...
// TerminateProcess sends SIGTERM then SIGKILL.
